...
export default function SubscriptionPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-24 sm:pb-12 min-w-0 overflow-x-hidden">
      ...
      {/* ── Checkout Modal (Full Viewport Coverage via Portal to document.body) ───── */}
      {mounted && showCheckoutModal && createPortal(
        <div className="fixed inset-0 top-0 left-0 right-0 bottom-0 w-screen h-screen bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-[99999] overflow-y-auto m-0">
