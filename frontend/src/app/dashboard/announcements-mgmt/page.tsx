...
export default function AnnouncementsMgmtPage() {
  ...
  return (
    <div className="space-y-6 w-full max-w-5xl mx-auto pb-32 sm:pb-24">
      ...
      {announcements.length === 0 ? (
        ...
        <div className="space-y-4 w-full">
          {announcements.map((ann) => {
            ...
            return (
              <div key={ann.id} className="bg-white p-4 sm:p-5 rounded-xl border border-slate-200 shadow-xs flex flex-col justify-between space-y-3 relative hover:border-slate-300 transition-colors duration-150 break-words w-full">
                <div className="space-y-2">
                  <div className="flex justify-between items-start gap-2">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {(!Array.isArray(ann.readStatus) || !ann.readStatus.includes(currentUser?.id)) && (
                        <span className="w-2.5 h-2.5 rounded-full bg-blue-600 animate-pulse" title="Unread Notice" />
                      )}
                    </div>
                  ...
                  <h3 className="font-bold text-slate-800 text-[14px] leading-tight break-words">{ann.title}</h3>
                  ...
                  {isExamSchedule ? (
                      ...
                      return (
                        <div className="space-y-2 mt-1">
                          ...
                          {details.instructions && (
                            <div className="text-[10px] text-slate-600 bg-indigo-50/30 p-2.5 rounded-lg border border-indigo-100/20 leading-normal break-words">
                    ...
                    <p className="text-xs text-slate-600 font-normal leading-relaxed whitespace-pre-wrap break-words">{cleanContent}</p>
                  )}
                </div>
