...
export class TeachersService {
  ...
  async assignClassSubject(
    ...
    if (!teacher) {
      throw new NotFoundException('Teacher profile not found for active tenant context.');
    }
    ...
    if (!classSection) {
      throw new NotFoundException('Class section not found for active tenant context.');
    }
    ...
    if (!subject) {
      throw new NotFoundException('Subject not found for active tenant context.');
    }
